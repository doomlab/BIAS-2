...
fulldata = fulldata[ order(fulldata$N, fulldata$levels, -fulldata$stdev, fulldata$correl) , ]
...
biasdata$eta2p = rep(c(rep(eta2plevel3sd5,6),rep(eta2plevel3sd3,6),rep(eta2plevel3sd1,6),
                   rep(eta2plevel4sd5,6),rep(eta2plevel4sd3,6),rep(eta2plevel4sd1,6),
                   rep(eta2plevel5sd5,6),rep(eta2plevel5sd3,6),rep(eta2plevel5sd1,6),
                   rep(eta2plevel6sd5,6),rep(eta2plevel6sd3,6),rep(eta2plevel6sd1,6)),16)
...
write.csv(Full.bias.data, "BiasData.csv")
